                    ...
                    <div class="card-body p-0">
                        <!-- Nested Row within Card Body -->
                                ...
                                <div class="p-5">
                                    ...
                                    Editar lista precios cliente
                                </a>
                                    </div>
                                
                                    <div class="text-center">
                                        <a class="small" href="../vistas/asignarListaPrecios.php">Regresar a la busqueda</a>
                                    </div>
                                </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="form-group row">
                                    ...
                                    <p class="mb-4">Lista Precios definida:</p>
                                    </div>
                                    <div class="col-sm-6">
                                    <select class="form-control form-control-user" id="definido" name="definido">
                                    <option select="false" class="mb-4"><?php echo " "?></option>
                                    <?php 
                                            try{
                                            $serverName = "192.168.1.5";
                                            $connectionInfo = array( "Database"=>"V6INTER", "UID"=>"sa", "PWD"=>"Int3r_Cart0n.");
                                       ...
                                       $sql = "SELECT Lista FROM  ListaPrecios group by Lista";
                                            $stmt = sqlsrv_query( $conn, $sql );?>
                                           <?php while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ){
                                            if($listaDefinido==$row["Lista"]){?>
                                            <option  selected="true" class="mb-4"><?php echo $row["Lista"]?></option>
                                             <?php }elseif($row["Lista"]!=""){  ?>
                                                <option select="false" class="mb-4"><?php echo $row["Lista"]?></option>
                                                <?php }}  ?>
                                           </select>
                                        <input type="text" hidden class="form-control form-control-user" id="cte" name="cte" value="<?php echo $cliente?>" >
                                           ...
                                           <div class="form-group row">
                                           <div class="col-sm-6 mb-3 mb-sm-0">
                                           <p class="mb-4">Lista de pecios asignados:</p>
                                    ...
                                    <option class="mb-4" selected="true">Seleccione nueva lista de precio</option>
                                           <?php 
                                            try{
                                            $serverName = "192.168.1.5";
                                            $connectionInfo = array( "Database"=>"V6INTER", "UID"=>"sa", "PWD"=>"Int3r_Cart0n.");
                                       ...
                                       $sql = "SELECT Lista FROM  ListaPrecios group by Lista";
                                           ...
                                           <?php while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ) {
                                            if($row["Lista"]!=""){?>
                                            <option class="mb-4"><?php echo $row["Lista"]?></option>
                                             <?php } } ?>
                                           </select>
                                        <input type="text" hidden class="form-control form-control-user" id="cliente" name="cliente" value="<?php echo $cliente?>" >
                                      ...
                                      <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                    <p class="mb-4">Comentario:</p>
                                    </div>
                                    <div class="col-sm-6">
                                    <textarea  class="mb-4" name="comentario"><?php echo  $comentarios?></textarea>
                                        <input type="text" hidden class="form-control form-control-user" id="cte" name="cte" value="<?php echo $cliente?>" >
                ...
                <button class="btn btn-primary" type="submit" name="actualizar" form="updateUser">Actualizar</button>
                <button class="btn btn-warning" type="submit" name="eliminarLista" form="updateUser">Eliminar lista</button>
